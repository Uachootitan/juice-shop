...
!(function () {
    ...
    function n(e) {
        for (var r = e.length; r--; ) {
            ...
            var a = u(i);
            if (a.result) return { node: i, type: a.nodeType };
        }
        return null;
    }
    function r(e) {
        for (var t = e.previousSibling; t; ) {
            if (g(t))
                if (s(t)) {
                    ...
                    var i = u(t);
                    if (i.result) return { node: t, type: i.nodeType };
                }
            t = t.previousSibling;
        }
        return null;
    ...
    function i(e) {
        for (var t = e.parentNode; t; ) {
            var n = u(t);
            if (n.result) return { node: t, type: n.nodeType };
            var i = r(t);
            if (i) return i;
            if ("HTML" === t.nodeName)
                try {
    ...
    function o(e) {
        for (var n = e.nextSibling; n; ) {
            if (g(n)) {
                var r = u(n);
                if (r.result) return { node: n, type: r.nodeType };
                if (s(n)) {
                    var i = a(n, t(n));
                    if (i) return i;
                }
        ...
        return (
            (n = g(e)
                ? c(e)
                    ...
                    ? R.HEADING
                    : S(e)
                    ? R.HAS_ALT_DESCRIPTION
                    : T(e)
                    ? R.COMPOSED_TEXT_NODES
                    : W(e)
                    ? R.IFRAME
                    : R.UNKNOWN
                : R.NOT_ALLOWED),
            { result: -1 === [R.NOT_ALLOWED, R.UNKNOWN, R.IFRAME].indexOf(n), nodeType: n }
        );
    }
    function c(e) {
    ...
    function b(e, t) {
        var n,
            r = ((n = {}), (n[R.CONTROL] = [{ tagName: "INPUT", role: "searchbox" }]), n),
            i = r[t];
        return (
            !!i &&
            i.some(function (t) {
    ...
    function T(e) {
        ...
        for (var t = e.childNodes, n = 0; n < t.length; n++) if (d(t[n])) return !0;
        return !1;
    }
    function x(e) {
        function t(e) {
    ...
    (D.isHeadingElement = _),
        (D.isLinkElement = N),
        (D.identifyElementType = function (e, t) {
            return e ? u(e, t).nodeType : R.UNKNOWN;
        }),
        (D.getNextAccessibilityTreeNode = e),
        (D.getPrevAccessibilityTreeNode = function (e) {
            ...
            if (a && !a.contains(t.node)) {
                ...
                if (0 !== l) t = { node: a.parentNode.children[l - 1], type: R.TABLE_CELL };
                else {
                    ...
                    if (0 !== s) {
                        ...
                        t = { node: u.children[u.children.length - 1], type: R.TABLE_CELL };
                    }
                }
            }
            return t;
...
!(function () {
    ...
    function r(e) {
        ...
        if (b())
            for (var n = [130, 160, 190, 205], r = t - 1 || 0, i = p.ElementsWithText.getElementsWithText(document, !1), o = 0; o < i.length; o++) {
                ...
                s && (d.resetInlineStyles(l, m + "-bigger-text", { "font-size": s + "px" }), c && d.applyInlineStyles(l, m + "-bigger-text", { "font-size": c + "px" }));
            }
            ...
            u.execForDocumentAndIframes(function () {
                var e,
                    n = null === (e = this.body) || void 0 === e ? void 0 : e.children;
                n &&
                    [].slice
                        .call(n)
                        .filter(function (e) {
                        ...
                        .forEach(function (e) {
                            d.resetInlineStyles(e, m + "-zoom", { zoom: 0 }), d.applyInlineStyles(e, m + "-zoom", { zoom: "1." + Math.round(1.5 * t) });
                        });
            });
    }
    function i() {
    ...
    function a(t) {
        try {
            ...
            if (v === g) {
                ...
                for (
                    var i = e([m, "-1-", h, "-", v]), a = e([m, "-2-", h, "-", v]), o = e([m, "-3-", h, "-", v]), l = e([m, "-4-", h, "-", v]), s = [].slice.call(t.querySelectorAll(e([".", i, ", .", a, ", .", o, ", .", l]))), c = 0;
                    c < s.length;
                    c++
                )
                    s[c].classList.remove(i), s[c].classList.remove(a), s[c].classList.remove(o), s[c].classList.remove(l);
            ...
            if (b()) {
                ...
                w.forEach(function (e) {
                    d.resetInlineStyles(e, m + "-bigger-text", { "font-size": "inherit" }), e.removeAttribute(f);
                });
            } else {
                var A = "data-" + m + "-zoom-styled",
                    w = t.querySelectorAll("[" + A + "]");
                [].slice.call(w).forEach(function (e) {
                    d.resetInlineStyles(e, m + "-zoom", { zoom: 0 }), e.removeAttribute(A);
                });
            }
        } catch (e) {}
    }
    ...
    var l,
        s = UserWayWidgetApp.addLib("bigger_text"),
    ...
    (function () {
        ...
        function r(e) {
            ...
            var n = document.createElement("div");
            return (
                (n.style.cssText = "width: 100% !important; height:" + L + "px !important; position:absolute !important;"),
                n.setAttribute(A, "true"),
                "topBlock" === e ? ((t.style.top = "0"), (n.style.background = _), (n.style.bottom = "0")) : "bottomBlock" === e && ((t.style.bottom = "0"), (n.style.background = N), (n.style.top = "0")),
                t.appendChild(n),
                t
            );
        }
            ...
            p.disableReadingGuide(),
                ...
                g.execForDocumentAndIframes(function () {
                    try {
                        ...
                        if (e && e.classList) {
                            var t = e.classList;
                            -1 !== ["ie", "edge"].indexOf(w) ? t.add(m + "-ie") : t.add(m);
                        }
                    } catch (e) {}
                });
        }
        ...
        function o() {
            ...
            u.setAttribute(A, "true"),
                d.setAttribute(A, "true"),
                c.setAttribute(A, "true"),
                f.setAttribute(A, "true"),
        ...
        function s(e) {
            if (u) {
                ...
                u.style.setProperty("top", e.yPos - 15 + "px"),
                    ...
                    e.xPos < r.width / 2
                        ? (u.style.setProperty("left", r.width / 2 + "px"),
                          e.xPos > 15 ? t.style.setProperty("left", e.xPos + "px") : t.style.setProperty("left", "15px"),
                          e.xPos > 9
                              ? (c.style.setProperty("display", "block"), c.style.setProperty("left", e.xPos - 19 + "px"), d.style.setProperty("left", e.xPos + 5 + "px"), f.style.setProperty("left", e.xPos + 1 + "px"))
                              : (c.style.setProperty("display", "none"), d.style.setProperty("left", "10px"), f.style.setProperty("left", "8px")))
                        : e.xPos < i.right - r.width / 2
                        ? (u.style.setProperty("left", e.xPos + "px"),
                        ...
                        : e.xPos <= i.right - a.width / 2 - 12
                        ? (d.style.setProperty("display", "block"),
                          c.style.setProperty("left", e.xPos - 19 + "px"),
                          d.style.setProperty("left", e.xPos + 5 + "px"),
                          f.style.setProperty("left", e.xPos + 1 + "px"),
                          t.style.setProperty("left", e.xPos - r.width - r.width / 2 + a.width / 2 + 4 + "px"))
                        : e.xPos <= i.right - a.width / 2 - 8
                        ? t.style.setProperty("left", e.xPos - r.width - r.width / 2 + a.width / 2 + 4 + "px")
        ...
        var u,
            ...
            d,
            f,
            p = UserWayWidgetApp.addLib("cursor"),
        ...
        var W = function (e) {
            (e = e || window.event), s({ yPos: e.pageY, xPos: e.pageX });
        };
    ...
    (function () {
        ...
        function t() {
            return s ? Promise.resolve().then(e) : a.execJs(l + "widgetapp/2025-01-21-14-07-56/features/inline_dictionary_1737468476256.js", "sha256-VgCWiqk6XdvhlyZIiSbZPO/wub64NKPmAe/8DYDhd5Y=").then(e);
        }
        function n() {
            s && s.disable();
        }
    ...
    (function () {
        function e(e, t) {
            ...
            if (t && t.length)
                t.forEach(function (e) {
                    "INPUT" === e.tagName || "TEXTAREA" === e.tagName || (e.getAttribute && !0 === e.getAttribute("contenteditable"))
                        ? n.push(e)
        ...
        function t(e) {
            for (var t = 0; t < e.length; t++) {
                ...
                if (!(n instanceof SVGElement)) {
                    var r = n.classList;
                    ((r && r.value ? r.value : "") && (o.someInArray(p, n.classList.value.split(" ")) || o.someInArray(g, [n.tagName]))) ||
                        (n.classList && "function" == typeof n.classList.add && n.classList.add(f), s.applyInlineStyles(n, c, m));
                }
            }
        }
        function n(n, r, i) {
                        ...
                        r.length &&
                            r.forEach(function (e) {
                                e &&
                                    ...
                                    ((365323 === n && 320802 === n) ||
                                        !o.isOpenShadowRoot(e) ||
                                        o.getShadowRootChildren(e).forEach(function (e) {
                                            o.removeFeatureStyles({ element: e, activeCssClass: f, key: c, inlineStyles: m });
                                        }),
                                    o.removeFeatureStyles({ element: e, activeCssClass: f, key: c, inlineStyles: m }));
                            });
                    } catch (e) {}
...
!(function () {
            ...
            [].slice
                ...
                .forEach(function (e) {
                    if (!e.getAttribute("data-" + s + "-styled")) {
                        ...
                        var i = ["a", '[role="link"]'],
                            a = [].slice
                                .call(e.querySelectorAll("*"))
                                .filter(function (e) {
                                    return o.filterTransparentPositionedElements(e, i);
                                })
                                .filter(o.filterIgnoredElems)
                                .filter(t);
                        a.length > 0 &&
    ...
    (function () {
        function e() {
            ...
            if (!document.body.contains(S)) {
                if (A.length)
                    do {
                        var t = A.shift();
                        document.body.contains(t) && ((A = []), (e = t));
                    } while (A.length);
                r(e);
            }
        }
        function t() {
            (S = null), (T = null), h.stopReading();
        }
        function n() {
            if (S && S.nodeType !== Node.TEXT_NODE) {
                ...
                if (e)
                    do {
                        A.push(e), (e = e.parentElement);
                    } while (e && e !== document.body);
            }
        }
        function r(e, t) {
            void 0 === t && (t = {});
            var r = t.scrollToTarget,
                i = void 0 === r || r,
                a = t.focusElement,
                o = void 0 === a || a,
                l = t.checkTimeout,
                s = void 0 === l ? 500 : l;
            (S = e), e.nodeType === Node.TEXT_NODE && (e = e.parentNode), o && (e.focus({ preventScroll: !1 }), p(e) || (i && !e.classList.contains("uw-popup-item") && y.scrollToElementWithOffset(e, s, 10)), n());
        }
        function i() {
            var e;
            _ ? ((e = _), (_ = null)) : (e = m.getNextAccessibilityTreeNode(S)), e && e.node && (r(e.node, { scrollToTarget: !1, focusElement: !1 }), (T = e));
        }
        function a() {
            return S && S.nodeType === Node.ELEMENT_NODE && (S.classList.contains("uw-popup-main-tab") || S.classList.contains("uw-popup-item"));
        }
        function o(e) {
            W = !0;
            var t = e.altKey || e.ctrlKey || e.shiftKey;
            ("ArrowLeft" !== e.code && 37 !== e.keyCode && 37 !== e.which) ||
                t ||
                setTimeout(function () {
                    l("ArrowLeft"), a() || O || (e.preventDefault(), g.findPrevElementForReader());
                }, 50),
                ("ArrowRight" !== e.code && 39 !== e.keyCode && 39 !== e.which) ||
                    t ||
                    setTimeout(function () {
                        l("ArrowRight"), a() || O || (e.preventDefault(), g.findNextElementForReader());
                    }, 50);
            var n = m.identifyElementType(S);
            ("ArrowUp" !== e.code && 38 !== e.keyCode && 38 !== e.which) ||
                t ||
                "CONTROL" !== n ||
                "SELECT" !== S.tagName ||
                setTimeout(function () {
                    E.emit(g.EVENTS.ELEMENT_CONTROL_CHANGED, { node: S, type: n });
                }, 0),
                ("ArrowDown" !== e.code && 40 !== e.keyCode && 40 !== e.which) ||
                    t ||
                    "CONTROL" !== n ||
                    "SELECT" !== S.tagName ||
                    setTimeout(function () {
                ...
                setTimeout(function () {
                    E.emit(g.EVENTS.USER_NAVIGATION_KEYDOWN, e, { node: S, type: n });
                }, 0);
        }
        function l(e) {
            var t,
                n = document.querySelector('iframe[name="userwayScreenReader"]');
            (null === (t = null === n || void 0 === n ? void 0 : n.contentWindow) || void 0 === t ? void 0 : t.postMessage) && n.contentWindow.postMessage({ isUserWay: !0, action: "screen-reader", data: e }, "*");
        }
        function s(e) {
            if (((W = !0), !O)) {
                var t = { userAction: W, clickEvent: e };
                e = e || window.event;
                var n = e.target || e.srcElement;
                if (n) {
                    var i = m.identifyElementType(n);
                    if (n === S) return void ("CONTROL" === i ? E.emit(g.EVENTS.ELEMENT_CONTROL_CHANGED, { node: n, type: i }) : (r(n, { scrollToTarget: !1 }), E.emit(g.EVENTS.ELEMENT_SELECTED, { node: n, type: i }, t)));
                    "UNKNOWN" === i
                        ? (r(n, { scrollToTarget: !1 }), g.findNextElementForReader())
                        : "CONTROL" !== i
                        ? (r(n, { scrollToTarget: !1 }), E.emit(g.EVENTS.ELEMENT_SELECTED, { node: n, type: i }, t))
                        : y.isSafari && "CONTROL" === i && n.focus();
                }
            }
        }
        function u(e) {
            ...
            try {
                ...
                if (S === t.activeElement) return;
                var i = t.activeElement,
                    a = m.identifyElementType(i, { checkParentNodeAria: !0 });
                r(t.activeElement), E.emit(g.EVENTS.ELEMENT_SELECTED, { node: i, type: a }, n);
            } catch (e) {
            } finally {
                setTimeout(function () {
                    O = !1;
        ...
        function c(e) {
            ...
            if ((("KeyL" !== e.code && 76 !== e.keyCode && 76 !== e.which) || (x = !0), ("KeyH" !== e.code && 72 !== e.keyCode && 72 !== e.which) || (C = !0), ("ArrowUp" === e.code || 38 === e.keyCode || 38 === e.which) && !n)) {
                var i = void 0;
                C ? (i = m.getPrevHeader(S)) : x && (i = m.getPrevLandmark(S)), i && i.node && (r(i.node), (t.markerNav = !0), E.emit(g.EVENTS.ELEMENT_SELECTED, i, t));
            }
            if (("ArrowDown" === e.code || 40 === e.keyCode || 40 === e.which) && !n) {
                var a = void 0;
                C ? (a = m.getNextHeader(S)) : x && (a = m.getNextLandmark(S)), a && a.node && (r(a.node), (t.markerNav = !0), E.emit(g.EVENTS.ELEMENT_SELECTED, a, t));
            }
        }
        function d(e) {
            return "KeyL" === e.code || 76 === e.keyCode || 76 === e.which ? void (x = !1) : "KeyH" === e.code || 72 === e.keyCode || 72 === e.which ? void (C = !1) : void 0;
        }
        function f(e) {
            O = !0;
            try {
                var t = m.identifyElementType(e),
                    n = { userAction: W };
                r(e), E.emit(g.EVENTS.ELEMENT_SELECTED, { node: e, type: t }, n);
            } catch (e) {
            } finally {
                setTimeout(function () {
                    O = !1;
        ...
        var g = window.UserWayWidgetApp.addLib("keyboard_navigation"),
            m = window.UserWayWidgetApp.getLib("accessibility_tree_walker"),
            y = window.UserWayWidgetApp.getLib("util"),
            v = window.UserWayWidgetApp.getLib("dom_observer"),
            h = window.UserWayWidgetApp.getLib("screen-reader-t"),
            E = window.UserWayWidgetApp.getLib("event_emitter");
        g.EVENTS = {
            ...
            DOM_OBSERVER_DOM_CHANGED_EVENT: v.DOM_OBSERVER_DOM_CHANGED_EVENT,
        };
        var b,
            w = !1,
            A = [],
        ...
        E.on(g.EVENTS.POPUP_FOUND, N),
            (g.isEnabled = function () {
                return w;
            }),
            (g.onWidgetClosed = function () {
                if (w && S) {
                    var e = m.getPrevAccessibilityTreeNode(S),
                        t = (e && e.node) || null,
                        n = m.getNextAccessibilityTreeNode(t);
                    r(n.node, { scrollToTarget: !1 }), n && E.emit(g.EVENTS.ELEMENT_SELECTED, n, {});
                }
            }),
            (g.enable = function () {
                w ||
                    ((A = []),
                    (w = !0),
                    E.on(g.EVENTS.POPUP_FOUND, f),
                    E.on(g.EVENTS.DOM_OBSERVER_DOM_CHANGED_EVENT, L),
                    y.execForDocumentAndIframes(function () {
                        this.addEventListener("keydown", c, !0), this.addEventListener("keyup", d, !0), this.addEventListener("focusin", u, !0);
                    }),
                    setTimeout(function () {
            ...
            (g.disable = function () {
                w &&
                    ((w = !1),
                    (_ = null),
                    E.off(g.EVENTS.POPUP_FOUND, f),
                    E.off(g.EVENTS.DOM_OBSERVER_DOM_CHANGED_EVENT, L),
                    y.execForDocumentAndIframes(function () {
                        this.removeEventListener("keydown", c, !0), this.removeEventListener("keyup", d, !0), this.removeEventListener("focusin", u, !0);
                    }),
                    h.disable(),
                    g.disableReaderNavigationRules(),
                    (A = []));
            }),
            (g.enableReaderNavigationRules = function () {
                y.execForDocumentAndIframes(function () {
                    this.addEventListener("keydown", o), this.addEventListener("click", s);
                }),
                    i();
            }),
            (g.disableReaderNavigationRules = function () {
                y.execForDocumentAndIframes(function () {
                    this.removeEventListener("keydown", o), this.removeEventListener("click", s);
                }),
                    t();
            });
        var S, T;
        (g.getInitialReaderElement = function () {
            return T;
        }),
            (g.findNextElementForReader = function () {
                var e = { userAction: W },
                    t = m.getNextAccessibilityTreeNode(S) || m.getNextAccessibilityTreeNode(null);
                t && t.node && (r(t.node), E.emit(g.EVENTS.ELEMENT_SELECTED, t, e));
            }),
            (g.findPrevElementForReader = function () {
                var e = { userAction: !0 },
                    t = m.getPrevAccessibilityTreeNode(S);
                if (!t) {
                    for (var n = document; n.lastChild; ) n = n.lastChild;
                    t = m.getPrevAccessibilityTreeNode(n);
                }
                t && t.node && (r(t.node), E.emit(g.EVENTS.ELEMENT_SELECTED, t, e));
            });
        var x = !1,
            ...
            y.off(d, n),
                o.execForDocumentAndIframes(function () {
                    ...
                    (365323 === n || 320802 === n ? e(this) : [].slice.call(this.querySelectorAll("." + f))).forEach(function (e) {
                        var t;
                        (null === (t = null === e || void 0 === e ? void 0 : e.classList) || void 0 === t ? void 0 : t.remove) &&
                            ((365323 === n && 320802 === n) ||
                                !o.isOpenShadowRoot(e) ||
                                o.getShadowRootChildren(e).forEach(function (e) {
                                    o.removeFeatureStyles({ element: e, activeCssClass: f, key: c, inlineStyles: m });
                ...
                for (var n = u.ElementsWithText.getElementsWithText(document, !1), r = 0; r < n.length; r++) {
                    ...
                    if (!i.hasAttribute(d) && !i.getAttribute("data-line-height-feature-value")) {
                        var a = "px",
                            ...
                            l = void 0;
                        -1 !== ["inherit", "initial", "unset", "normal"].indexOf(o) ? ((a = "em"), (l = 1.2)) : (l = parseInt(window.getComputedStyle(i).getPropertyValue("line-height").split("px")[0], 10));
                        var f = { "line-height": l + l * p };
                        2 === t ? (f["line-height"] = l + l * p * 3) : 3 === t && (f["line-height"] = l + l * p * 4),
                            (f["line-height"] = f["line-height"] + a),
                            s.applyInlineStyles(i, c, f),
    ...
    (function () {
        ...
        function r(e) {
            for (
                var r = document.querySelector(".uw-page-structure-modal-content"),
                    i = document.querySelector(".uw-popup-main-panel-headers"),
                    a = document.querySelector(".uw-popup-main-panel-landmarks"),
                    o = document.querySelector(".uw-popup-main-panel-links"),
                    l = !1,
                    s = 0;
                s < e.length;
                s++
        ...
        function i(e) {
            ...
            e.setAttribute(R, ++M);
            return N.isElementVisible(e) && "userway-h1-heading" !== e.getAttribute("id")
                ? '<div class="uw-popup-item uw-popup-item_level-' +
                      t +
                      '" ' +
                      k +
                      '="' +
                      M +
                      '" tabindex="0" role="link"><div aria-label="Heading level ' +
                      t +
                      ': " class="uw-popup-item-label header-label"><span aria-hidden="true">h' +
                      t +
                      '</span></div><div class="uw-popup-item-text">' +
                      r +
                      "</div></div>"
                : '<div class="uw-popup-item uw-popup-item_level-' +
                      t +
                      '" tabindex="0" role="link"><div aria-label="Heading level ' +
                      t +
                      ': " class="uw-popup-item-label header-label-invisible"><span aria-hidden="true">h' +
                      t +
                      '</span></div><div class="uw-popup-item-text">' +
                      r +
                      '</div><img src="' +
                      S.cdn +
                      'widgetapp/images/invisible-heading.svg" class="invisible-icon" aria-hidden="true" data-uw-rm-ignore="" alt="invisible heading icon decorative" width="20" height="20"/></div>';
        }
        function a(e, t) {
            ...
            "HEADER" === r
                ...
                : "MAIN" === r || "main" === i
                ? (l += "Main")
                : "FOOTER" === r || "contentinfo" === i
                ? (l += "Footer")
                : "ASIDE" === r || "complementary" === i
                ? (l += "Complementary")
                : "SECTION" === r || "region" === i
                ? (l += "Section")
                : "ARTICLE" === r || "article" === i
            ...
            return (
                ...
                '<div class="uw-popup-item uw-popup-item_level-' +
                    ...
                    '="' +
                    M +
                    '" tabindex="0" role="link"><div class="uw-popup-item-label"><img src="' +
                    S.cdn +
                    'widgetapp/images/code-label.svg" aria-hidden="true" data-uw-rm-ignore="" alt="Landmark icon decorative" width="32" height="22"/></div><div class="uw-popup-item-text">' +
                    l +
                    "</div></div>"
            );
        }
        ...
        function l(e) {
            ...
            B.push({ text: n.toLowerCase(), href: o(i) });
            var s = o(i),
                u = s.startsWith("/"),
            ...
            e.setAttribute(R, ++M);
            var m =
                '<div class="uw-popup-item-label"><img src="' +
                S.cdn +
                'widgetapp/images/link-label.svg" aria-hidden="true" data-uw-rm-ignore="" alt="Link icon decorative" width="32" height="22"/></div><div class="uw-popup-item-text">' +
                n +
                p +
                g +
                "</div>";
                ...
                !(function (e) {
                    ...
                    t.addEventListener("click", function (e) {
                        ...
                        t.addEventListener("keydown", function (e) {
                            ...
                            ("ArrowDown" !== e.code && 40 !== e.keyCode && 40 !== e.which) || (e.preventDefault(), t.nextSibling && t.nextSibling.focus()),
                                ("ArrowUp" !== e.code && 38 !== e.keyCode && 38 !== e.which) || (e.preventDefault(), t.previousSibling && t.previousSibling.focus()),
        ...
        function m(e) {
            ...
            t &&
                ...
                t.addEventListener("keydown", function (t) {
                    ("Enter" !== t.code && 13 !== t.keyCode && 13 !== t.which) || (t.preventDefault(), e && e.focus(), h()),
        ...
        function y() {
            return (
                S.settings["userway-s15"] && !!S.settings["userway-s15"].value ? N.addUwStylesheetUDFFont(S) : N.addUwStylesheetMetropolisFont(S),
                N.addPageStructureModal(U, S),
                C.setPageStructureModalColor(),
                new Promise(function (e, t) {
                    N.loadDeferredJs(
                        ...
                        function () {
                            ...
                            if (n) {
                                var r = document.querySelector(".uw-popup-header-text"),
                                    ...
                                    d = document.querySelector(".uw-popup-header-close");
                                (r.innerText = n.title),
                                    (i.innerText = n.tabs.headers),
                                    (a.innerText = n.tabs.landmarks),
                                    (o.innerText = n.tabs.links),
                                    (l.innerText = n.no_items.headers),
                                    (s.innerText = n.no_items.landmarks),
                        ...
                        { charset: "utf-8" },
                        "sha256-ntxTWBnUc90cH2VFrMK6RHKAR1xOnO6BDfbjO/8u4yU="
                    );
                })
            );
        }
        function v(t, n) {
            return (
                void 0 === t && (t = I.HEADERS),
                F
                    ? Promise.resolve()
                    : ((F = !0),
                      T.on(P, q),
                      e(),
                      (A = UserWayWidgetApp.getLib("accessibility_tree_walker")),
                      y()
                          .then(function () {
                              W.isEnabled() && W.readTextContent({ contentToRead: "page structure modal window opened", language: S.language });
                                  ...
                                  !(function (e) {
                                      ...
                                      t.addEventListener("click", function (e) {
                                          ...
                                          t.addEventListener("keydown", function (t) {
                                              ...
                                              if (
                                                  (("Home" !== t.code && 36 !== t.keyCode && 36 !== t.which) || (t.preventDefault(), g(s[0])),
                                                  ("End" !== t.code && 35 !== t.keyCode && 35 !== t.which) || (t.preventDefault(), g(s[s.length - 1])),
                              ...
                              for (var h = 0; h < u.length; h++)
                                  !(function (e) {
                                      u[e].addEventListener("keydown", function (t) {
                                          ("ArrowRight" !== t.code && 39 !== t.keyCode && 39 !== t.which) || (t.preventDefault(), g(e === s.length - 1 ? s[0] : s[e + 1])),
                                              ("ArrowLeft" !== t.code && 37 !== t.keyCode && 37 !== t.which) || (t.preventDefault(), g(0 === e ? s[s.length - 1] : s[e - 1])),
                                              ("Home" !== t.code && 36 !== t.keyCode && 36 !== t.which) || (t.preventDefault(), g(s[0])),
                                              ("End" !== t.code && 35 !== t.keyCode && 35 !== t.which) || (t.preventDefault(), g(s[s.length - 1]));
                                      });
                                  })(h);
        ...
        function h(e) {
            void 0 === e && (e = !1), document.getElementById(D).remove(), (F = !1), T.off(P, q), L && clearInterval(L), C.setFeature("s11", !1), N.postMessage({ action: "close_ps_popup", force_focus: !e }), (M = 0);
        ...
        var A,
            L,
            _ = UserWayWidgetApp.getLib("page_structure"),
        ...
        (_.init = function () {
            N.addStylesheetOnce("https://cdn.userway.org/styles/2025-01-21-14-07-56/widget_lazy.css?v=1737468476256");
        }),
    ...
    (function () {
                            ...
                            i.length &&
                                i.forEach(function (e) {
                                    e.classList.remove("userway-s14-active"),
                                        ...
                                        (365323 === n && 320802 === n) ||
                                            !a.isOpenShadowRoot(e) ||
                                            a.getShadowRootChildren(e).forEach(function (e) {
                                                var t;
        ...
        var i = UserWayWidgetApp.addLib("spacing_text"),
            ...
            p = "https://cdn.userway.org/styles/2025-01-21-14-07-56/userway-s14.css";
...
!(function () {
    function e() {
        C.execForDocumentAndIframes(function () {
            try {
                ...
                m(this), v(this.defaultView), O.iframeVideos.pause(this), l(this), c(this), i(this), n(this), E(this), w(this.defaultView), L(this.defaultView), S(this);
                var t = this;
                M.push(function () {
                    return m(t);
                });
    ...
    function t() {
        C.execForDocumentAndIframes(function () {
            try {
                ...
                P && (h(this), O.iframeVideos.play(this), s(), d(this), a(this), r(this), b(this), A(this), N(this), T(this));
            } catch (e) {
                console.warn(e);
            }
        }),
    ...
    function n(e) {
        [].slice.call(e.querySelectorAll("marquee:not([" + k + "])")).forEach(function (e) {
            e.stop(), e.setAttribute(R, "true");
        });
    }
    function r(e) {
        [].slice.call(e.querySelectorAll("marquee[" + R + '="true"]')).forEach(function (e) {
            e.start(), e.removeAttribute(R);
        });
    }
    function i(e) {
        o(!0, e);
    ...
    function o(e, t) {
        var n = [].slice.call(e ? t.querySelectorAll("video:not([" + k + "])") : t.querySelectorAll("video[data-uw-video-paused]:not([" + k + "])")),
            r = [].slice.call(e ? t.querySelectorAll("audio:not([" + k + "])") : t.querySelectorAll("audio[data-uw-audio-paused]:not([" + k + "])"));
        n.forEach(function (t) {
            var n = "autoplay" === t.getAttribute("autoplay");
            e && (t.uwplaying || n)
                ? (t.pause(), (t.play = function () {}), t.setAttribute("data-uw-video-paused", "true"))
                : e || t.uwplaying || ((t.play = HTMLVideoElement.prototype.play), t.play(), t.removeAttribute("data-uw-video-paused"));
        }),
            r.forEach(function (t) {
    ...
    function l(e) {
        if (u())
            try {
                for (var t = e.querySelectorAll("body, body *:not([" + k + "])"), n = 0; n < t.length; n++) {
                    var r = t[n];
    ...
    function f(e) {
        var t = e.querySelectorAll("img:not([" + k + "])");
    ...
    function p(e) {
        var t = e.document.querySelectorAll("*:not(img):not([" + k + "])");
    ...
    function m(e) {
        ...
        try {
            for (var i = __values(r), a = i.next(); !a.done; a = i.next()) {
                var o = a.value;
                o.complete ? g(o) : o.addEventListener("load", g, { once: !0 });
            }
        } catch (e) {
            t = { error: e };
        } finally {
        ...
        try {
            for (var i = __values(r), a = i.next(); !a.done; a = i.next()) {
                ...
                if (l.slice(4, -1).replace(/"/g, "").startsWith("data:image/gif;base64")) {
                    y(o, l.slice(4, -1).replace(/"/g, ""));
                } else {
                    y(o, l.match(/url\(\s*?['"]?\s*?(\S+?)\s*?["']?\s*?\)/i)[1]);
                }
            }
        } catch (e) {
            t = { error: e };
    ...
    function h(e) {
        var t,
            n,
            r = e.querySelectorAll("canvas[data-original-gif]");
        try {
            for (var i = __values(r), a = i.next(); !a.done; a = i.next()) {
                var o = a.value,
    ...
    function E(e) {
        [].slice.call(e.querySelectorAll("svg:not([" + k + "])")).forEach(function (e) {
            "function" == typeof e.pauseAnimations && (e.pauseAnimations(), e.setAttribute(R, "true"));
        });
    }
    function b(e) {
        [].slice.call(e.querySelectorAll("svg[" + R + '="true"]')).forEach(function (e) {
            e.unpauseAnimations(), e.removeAttribute(R);
        });
    }
    function w(e) {
        [].slice.call(e.document.querySelectorAll("lottie-player:not([" + k + "])")).forEach(function (e) {
            "function" == typeof e.pause && (e.pause(), e.setAttribute(R, "true"));
        }),
            e.lottie &&
                "function" == typeof e.lottie.getRegisteredAnimations &&
                e.lottie.getRegisteredAnimations().forEach(function (e) {
                    e.isPaused || (e.pause(), F.push(e));
                });
    }
    function A(e) {
        [].slice.call(e.querySelectorAll("lottie-player[" + R + '="true"]')).forEach(function (e) {
            "function" == typeof e.unpauseAnimations && e.unpauseAnimations(), e.removeAttribute(R);
        }),
            F.length > 0 &&
    ...
    function L(e) {
        [].slice.call(e.document.querySelectorAll("dotlottie-player:not([" + k + "])")).forEach(function (e) {
            e.setAttribute(R, "true"), "function" == typeof e.pause && e.pause(), e.addEventListener("play", _), e.addEventListener("frame", _);
        });
    }
    function _(e) {
    ...
    function N(e) {
        [].slice.call(e.querySelectorAll("dotlottie-player[" + R + '="true"]')).forEach(function (e) {
            e.removeEventListener("play", _), e.removeEventListener("frame", _), "function" == typeof e.play && e.play(), e.removeAttribute(R);
        });
    }
    function S(e) {
        var t,
            n,
            r = e.getElementsByClassName("indiana-scroll-container");
        try {
            for (var i = __values(r), a = i.next(); !a.done; a = i.next()) {
    ...
    var x = UserWayWidgetApp.addLib("stop_animations"),
        C = UserWayWidgetApp.getLib("util"),
        W = UserWayWidgetApp.getLib("event_emitter"),
        O = UserWayWidgetApp.getLib("stop_animations_modules"),
        D = UserWayWidgetApp.getLib("dom_observer"),
        R = "userway-s13",
        k = "data-uw-ignore-s13",
        I = "userway-s13_offtransition",
        U = D.DOM_OBSERVER_DOM_CHANGED_EVENT,
        P = !1,
        M = [];
    (x.enable = e), (x.disable = t);
    var F = [];
    !(function () {
        try {
...
!(function () {
        ...
        u.execForDocumentAndIframes(function () {
            ...
            r.apply(this).forEach(function (e) {
                if (!e.getAttribute("data-text-align-feature-value")) {
                    var n = { "text-align": y["text-align"][t] };
    ...
    function n() {
        o.off(s, t),
            u.execForDocumentAndIframes(function () {
                r.apply(this).forEach(function (e) {
                    e.getAttribute("data-text-align-feature-value") && e.removeAttribute("data-text-align-feature-value"), e.style.justifyContent && c.resetInlineStyles(e, d, { "justify-content": "initial" }), c.resetInlineStyles(e, d, m);
                });
            });
    }
    function r() {
        var e = [];
        return (
            this.querySelectorAll("body *").forEach(function (t) {
                E(t) ||
                    t.closest("[" + p + "]") ||
                    t.closest("[" + f + "]") ||
                    t.closest("#" + g) ||
                    v.includes(t.tagName) ||
                    void 0 === t.style ||
                    (e.push(t), u.isOpenShadowRoot(t) && e.push.apply(e, __spreadArray([], __read(u.getShadowRootChildren(t)), !1)));
            }),
            e
        );
    }
    function i() {
        var e,
            t,
            n = document.querySelectorAll("[" + f + "],[" + p + "]");
        try {
    ...
    var a = UserWayWidgetApp.addLib("text_align"),
        ...
        m = { "text-align": "initial" },
        y = { "text-align": { 1: "left", 2: "right", 3: "center", 4: "justify" } },
    ...
    (function () {
        ...
        function n(e, t, n, r, i, a, o) {
            var l = {},
                s = {};
            return (
                e + n + 50 > r ? ((l.right = i - e + 10 + "px"), (s.right = (i - e + 15 >= 20 ? i - e + 15 : 20) + "px")) : ((l.left = a + e + 15 + "px"), (s.left = (a + e + 20 >= 20 ? a + e + 20 : 20) + "px")),
                (l.top = o + t + 10 + "px"),
                (s.top = (o + t + 10 >= 50 ? o + t + 10 : 50) + "px"),
                { styleBefore: l, styleAfter: s }
            );
        }
        function r(e, t, r, i) {
            ...
            if (u) {
                u.innerHTML = t;
                var c = { fontFamily: _, transition: "all 0.1s ease-in-out", whiteSpace: "normal" },
                    d = u.offsetWidth + 40;
                u.offsetHeight;
        ...
        var A,
            ...
            _,
            N,
            S = UserWayWidgetApp.addLib("tooltips"),
            T = UserWayWidgetApp.getLib("util"),
            x = "userway-s12",
            C = 200,
            W = 60,
        ...
        (S.enable = function () {
            ...
            (S.disable = function () {
                var e = document.querySelector("div.uwy"),
                    t = { "en-US": "Our site is built for you; use it in a way that works best for you", ar: "ØªÙ… ØªØµÙ…ÙŠÙ… Ù…ÙˆÙ‚Ø¹Ù†Ø§ Ù…Ù† Ø£Ø¬Ù„Ùƒ. Ø§Ø³ØªØ®Ø¯Ù…Ù‡ Ø¨Ø·Ø±ÙŠÙ‚Ø© ØªÙ†Ø§Ø³Ø¨Ùƒ Ø¨Ø´ÙƒÙ„ Ø£ÙØ¶Ù„" };
                null === e || void 0 === e || e.setAttribute("title", location.hostname === atob("cmV2YW1wLnJha2JhbmsuYWU=") ? t[k.language] : T.getUserWayIconElementTitle(k)),
                    (A = {}),
                    (L = {}),
                    T.execForDocumentAndIframes(function () {
                        try {
...
!(function () {
    ...
    function t() {
        h.off(b, W),
            clearTimeout(g),
            f(),
            [].slice.call(document.querySelectorAll(".userway-s3-1, .userway-s3-2, .userway-s3-3, .userway-s3-4, .userway-s3-4-black, .userway-s3-4-light, /*.userway-s3-1-ff,*/ .userway-s3-1-white-bg")).forEach(function (e) {
    ...
    function i() {
        ...
        if (e) {
            ...
            if (e.classList.contains("userway-s3-1-white-bg")) return r({ force: !1 });
            !n && r({ force: !0 });
        }
    }
    function a(e) {
    ...
    function l(e) {
        ...
        return (
            ...
            !e.hasAttribute("data-uw-ignore-s3") &&
            !t
        );
    }
    function s(e) {
                ...
                a.forEach(function (n) {
                    if (!n.hasAttribute(s) && !n.hasAttribute(d)) {
                        ...
                        if (p(String(i), n))
                            if (O(n) || D(n)) {
                                if (
                                    (v.applyInlineStyles(n, h, o),
                                    (m.config.partner === atob("cmFrYmFuaw==") && window.location.pathname === atob("L3dwcy9wb3J0YWwvUHJlcGFpZENhcmRTZWxmQ2FyZQ==")) ||
                                        (m.config.partner === atob("cmFrYmFuaw==") && window.location.hostname.includes(atob("c21lc291aw=="))))
                                ) {
                                    var E = { "background-image": "none", "margin-top": "0" };
                                ...
                                if (A && N) return;
                                if (c(n) && -1 === ["FONT"].indexOf(n.tagName)) return void v.applyInlineStyles(n, h, { color: "inherit", "background-color": "inherit" });
                ...
                i.concat(a).forEach(function (e) {
                    if ("svg" === e.tagName) v.resetInlineStyles(e, L.dark.key, L.dark.svgImg), v.resetInlineStyles(e, L.light.key, L.light.svgImg);
                        ...
                        if ("A" === e.tagName && m.config.partner === atob("cmFrYmFuaw==") && window.location.pathname === atob("L3dwcy9wb3J0YWwvUHJlcGFpZENhcmRTZWxmQ2FyZQ==")) {
                            var t = { "background-image": "none", "margin-top": "0" };
    ...
    function p(e, t) {
        return (
            !e ||
            (-1 === t.classList.value.search(/slide/) &&
                -1 === t.classList.value.search(/overlay/) &&
                0 !== t.classList.value.search(/ups/) &&
                0 !== t.classList.value.search(/uai/) &&
                0 !== t.classList.value.search(/ulsti/) &&
                0 !== t.classList.value.search(/uiiw/) &&
                0 !== t.classList.value.search(/usr/))
        );
    }
    var g,
        m = UserWayWidgetApp.addLib("uw_color_manipulation_service"),
        ...
        T = [
            "[uw-el-blk-img]",
            ".glide__slide .carousel-slide",
            ".glide__slide [class*=__content]:has(+ [class*=__image])",
            ".container-parsys [class*=__image].contain+[class*=__content]",
            ".container-parsys [class*=__image].cover+[class*=__content]",
            ".container-parsys [class*=__video]+[class*=__content]",
        ],
        x = [
            "h1",
            "h2",
    ...
    (m.enableSmartContrast = function () {
        UserWayWidgetApp.ContextHolder.config.services.paidAi &&
            UserWayWidgetApp.ContextHolder.remediationModulePromise.then(function () {
                var e = UserWayWidgetApp.getLib("REMEDIATION_COLOR_CONTRAST");
                e.enableSmartContrast();
                var t = e.filter(null, { reset: !1 });
                e.run(t, !0);
            });
    }),
        (m.disableSmartContrast = function () {
            if (UserWayWidgetApp.ContextHolder.config.services.paidAi) {
                var e = UserWayWidgetApp.getLib("REMEDIATION_COLOR_CONTRAST");
                e && e.isSmartContrastEnabled && e.isSmartContrastEnabled() && e.disableSmartContrast(), window.postMessage({ isUserWay: !0, action: "remediation", type: "remediation-check" }, "*");
            }
        });
})();
var __assign =
...
!(function () {
    function e(e) {
        return l
            ? Promise.resolve()
            : n().then(function () {
                  (l = !0), window.miniWidget(__assign(__assign({}, e), { cssBundlePath: i }));
              });
    }
    function t() {
    ...
    function n() {
        return Promise.all([o.execJs(r, "sha256-7kCHQO8+JS2mNgGdv2ckdb5EYLg2YuLJzQIOzypJD/o="), o.addStylesheet(i)]);
    }
    var r = "https://cdn.userway.org/mini-widget/mini-widget.js?ts=1737468476256",
        i = "https://cdn.userway.org/mini-widget/style.css?ts=1737468476256",
...
!(function () {
    function e(e) {
        return l
            ? Promise.resolve()
            : n().then(function () {
                  (l = !0), window.nanoWidget(__assign(__assign({}, e), { cssBundlePath: i }));
              });
    }
    function t() {
    ...
    function n() {
        return Promise.all([o.execJs(r, "sha256-KkRs3+oRFll6mpqe1spLpzbViXgNuNKwy8SiYUkHBiM="), o.addStylesheet(i)]);
    }
    var r = "https://cdn.userway.org/nano-widget/nano-widget.js?ts=1737468476256",
        i = "https://cdn.userway.org/nano-widget/style.css?ts=1737468476256",
...
!(function () {
    function e(e) {
        return o
            ? o.available && o.available
                ...
                : Promise.resolve()
            : n().then(function () {
                  var t = __assign(__assign({}, e), { voiceNavigationCssBundlePath: i });
    ...
    function n() {
        return Promise.all([a.execJs(r, "sha256-81Gb3dQb5FTKG1mbY/MNnRaHUpUXXNMqGZ3dtiTknbk="), a.addStylesheet(i)]);
    }
    var r = "https://cdn.userway.org/voice-navigation/voice-navigation.js?ts=1737468476256",
        i = "https://cdn.userway.org/voice-navigation/style.css?ts=1737468476256",
        a = UserWayWidgetApp.getLib("util"),
        o = null,
...
var __awaiter =
    ...
    __generator =
        ...
        function (e, t) {
            ...
            return (
                (l = { next: n(0), throw: n(1), return: n(2) }),
                "function" == typeof Symbol &&
...
!(function (e) {
    ...
    (function () {
        function e() {
            l();
            var e = y
                .loadAndInitializeTtsScript()
                .then(function () {
                    (L = !0),
                        (N = null),
                        E.add(c),
                        m.enrichDomWithPreferableLanguage(),
                        v.enable({
                            readTextContent: r,
        ...
        function r(e) {
            ...
            return null === s
                ? (console.log("[SR] Not able to read text. Unssuported language found: " + t), Promise.resolve())
                : i && !_
                ? (console.log("[SR] Attempt to read alert message before user interaction"), Promise.resolve())
                : ((_ = !0),
                  y
                      .loadAndInitializeTtsScript()
                      .then(function () {
                          var e = { locale: s, isAlert: i, readingDelay: a || w, readingSpeedRate: o(l) };
                ...
                return __awaiter(t, void 0, void 0, function () {
                    ...
                    return __generator(this, function (a) {
                        switch (a.label) {
                            case 0:
                                return (
                                    (t = p.identifyElementType(e)),
                                    (n = m.getLocaleForElement(e)),
                                    (r = { isAlert: !1, locale: n, readingDelay: w, readingSpeedRate: o(), soundEffect: "CONTROL" === t }),
    ...
    (function () {
        function e() {
            return { keyClickAudio: new Audio(s) };
        }
        function t() {
            return c
                ? n
                ...
                : (n = new Promise(function (e, t) {
                      a.loadDeferredJs(
                          a.isChromeExtensionEnv() ? window.chrome.extension.getURL("rv.js") : l,
                          function () {
                              o.init(), (c = !1), (u = !0), e();
                          },
                          function (e) {
                          ...
                          {},
                          "sha256-ARDWPiKCeOKb50EGrh2uIF+1PcEo4zeKMIKdmod69N8="
                      );
                  }));
        }
        var n,
            ...
            l = "https://cdn.userway.org/widgetapp/2025-01-21-14-07-56/bundles/rvoice-10.js",
...
!(function (e) {
                ...
                return __generator(this, function (C) {
                    switch (C.label) {
                        case 0:
                            return (
                                (s = ""),
                                ((u = t(e, r)), "BEELINESPAN" === e.tagName && (e = e.parentNode), r !== ELEMENT_TYPE.TEXT_NODE)
                                    ? [3, 1]
                                    : ((s = e.textContent
                                          .trim()
                                          .replace(/(\n|\r\n)/g, "")
                        ...
                        case 4:
                            return r !== ELEMENT_TYPE.LANDMARK
                                ? [3, 5]
                                : ((s = u.ariaLabel || a.getLabelledByElements(u.ariaLabelledBy)),
                                  l(
                                      "HEADER" === u.tagName || "banner" === u.role
                                          ? n("header_land", i)
                                          : "NAV" === u.tagName || "navigation" === u.role
                                          ? n("nav_land", i)
                                          : "MAIN" === u.tagName || "main" === u.role
                                          ? n("main_land", i)
                                          : "FOOTER" === u.tagName || "contentinfo" === u.role
                                          ? n("footer_land", i)
                                          : "ASIDE" === u.tagName || "complementary" === u.role
                                          ? n("aside_land", i)
                                          : "SECTION" === u.tagName || "region" === u.role
                                          ? n("section_land", i)
                                          : "ARTICLE" === u.tagName || "article" === u.role
                                          ? n("art_land", i)
                                          : "FORM" === u.tagName || "form" === u.role
                                          ? n("from_land", i)
                                          : "search" === u.role
                                          ? n("search_land", i)
                                          : n("Landmark", i)
                        ...
                        case 5:
                            return r !== ELEMENT_TYPE.CONTROL
                                ...
                                : ((c = u.tagName),
                                  ...
                                  (v = u.ariaLabel),
                                  (h = !1),
                                  ("menuitem" !== d && "option" !== d && "tab" !== d) || ((s = v || (u.ariaLabelledBy ? a.getLabelledByElements(u.ariaLabelledBy) : a.composeElementTextRepresentation(e, s))), l(n("button", i)), (h = !0)),
                                  h || ("link" !== d && "A" !== c) || ((s = v || (u.ariaLabelledBy ? a.getLabelledByElements(u.ariaLabelledBy) : a.composeElementTextRepresentation(e, s))), l(n("link", i)), (h = !0)),
                                  h || ("button" !== d && "BUTTON" !== c)
                                      ? "INPUT" !== c ||
                                        ("button" !== p && "submit" !== p && "reset" !== p && "image" !== p) ||
                                        ((s = v || f || (u.ariaLabelledBy ? a.getLabelledByElements(u.ariaLabelledBy) : g)), l(n("button", i)), (h = !0), l(m ? n("disabled", i) : ""))
                                      : ((s = v || (u.ariaLabelledBy ? a.getLabelledByElements(u.ariaLabelledBy) : a.composeElementTextRepresentation(e, s))), l(n("button", i)), (h = !0), l(m ? n("disabled", i) : "")),
                                  h
                                      ? [3, 11]
                                      : ((E = a.isRequiredElement(e)),
                                        (b = "true" === e.getAttribute("aria-invalid")),
                                        (w = !y && !m),
                                        "checkbox" === d || ("INPUT" === c && "checkbox" === p) ? ((s = a.findLabelForControlElement(e, s)), l(n("checkbox", i)), l(w && E ? n("required", i) : ""), [4, o(100)]) : [3, 7]));
                        case 6:
                        ...
                        case 9:
                            "INPUT" === c &&
                                ((s = a.findLabelForControlElement(e, s)),
                                l(n("input", i)),
                                l(w && E ? n("required", i) : ""),
                                g ? "password" !== e.type && l(g) : l(n("blank", i)),
                                l(b ? n("invalid", i) : ""),
                                l(y ? n("readonly", i) : ""),
                                l(m ? n("disabled", i) : "")),
                                (C.label = 10);
                        case 10:
                            "TEXTAREA" === c && ((s = a.findLabelForControlElement(e, s)), l(n("textarea", i)), l(w && E ? n("required", i) : ""), l(g || n("blank", i)), l(y ? n("readonly", i) : ""), l(m ? n("disabled", i) : "")),
                                "LIGHTNING-TAB-BAR" === c && (A = e.querySelector('[aria-selected="true"]')) && ((s = a.composeElementTextRepresentation(A, s)), l("Tab")),
                                "SELECT" === c &&
                                    ((s = a.findLabelForControlElement(e, s)),
                                    l(n("combo box", i)),
                                    (L = e),
                                    (_ = L.selectedOptions[0]),
                                    (N = _ ? _.textContent : ""),
                                    (S = "[object Object]" !== L.value ? L.value : ""),
                                    (T = S || N) && l(n(T, i))),
                                (C.label = 11);
                        case 11:
                            return [3, 13];
                        case 12:
                            r === ELEMENT_TYPE.HAS_ALT_DESCRIPTION
                                ? ((c = u.tagName),
                                  (d = u.role),
                                  (v = u.ariaLabel),
                                  (f = e.getAttribute("alt") || ""),
                                  (x = e.getAttribute("title") || ""),
                                  ("IMG" !== c && "img" !== d) || (v ? (s = v) : f && (s = f), l(n("image", i))),
                                  "ABBR" === c && (s = x))
                                : r === ELEMENT_TYPE.TABLE_CELL && (s = e.dataset.uwReaderTableCell || ""),
                                (C.label = 13);
                        case 13:
    ...
    (function () {
        function e(e) {
            t();
            var n = [e];
            (n = e.nodeType === Node.TEXT_NODE && e.parentNode ? [e.parentNode] : [e]),
    ...
    (function () {
        function e(e) {
            var t = e.readTextContent,
                ...
                d = e.isInteracted;
            a(),
                y.enableReaderNavigationRules(),
                m.on(v.ELEMENT_SELECTED, n),
                m.on(v.ELEMENT_CONTROL_CHANGED, r),
                m.on(v.USER_NAVIGATION_KEYDOWN, i),
                m.on(v.DOM_OBSERVER_DOM_CHANGED_EVENT, o),
                (l = t),
                (s = c),
                (u = function () {
                    return (
        ...
        function t() {
            y.disableReaderNavigationRules(),
                m.off(v.ELEMENT_SELECTED, n),
                m.off(v.ELEMENT_CONTROL_CHANGED, r),
                m.off(v.USER_NAVIGATION_KEYDOWN, i),
                m.off(v.DOM_OBSERVER_DOM_CHANGED_EVENT, o),
                (l = s = function () {
                    return Promise.resolve();
                });
        }
        function n(e, t) {
            [ELEMENT_TYPE.UNKNOWN, ELEMENT_TYPE.HIDDEN_FOR_READER].includes(e.type)
                ? !t.markerNav && y.findNextElementForReader()
                : s(e.node)
                      .then(function () {
                          t.clickEvent || t.markerNav || ((e.type !== ELEMENT_TYPE.CONTROL || f.isMobile()) && y.findNextElementForReader());
                      })
                      .catch(function (e) {
                          E && console.error(e);
                      });
        ...
        function r(e) {
            if (e && e.type === ELEMENT_TYPE.CONTROL) {
                ...
                if ("checkbox" === i || ("INPUT" === n && "checkbox" === r) || "radio" === i || ("INPUT" === n && "radio" === r)) {
                    ...
                    l({ language: a.ttsLangIsoCode, contentToRead: p.getVoice(o, a.ttsLangIsoCode) });
                } else if ("SELECT" === n) {
                    var s = t,
                        ...
                        o = d || c;
                    o && l({ language: a.ttsLangIsoCode, contentToRead: p.getVoice(o, a.ttsLangIsoCode) });
                }
            }
        }
        function i(e, t) {
            if (t && t.type === ELEMENT_TYPE.CONTROL) {
                ...
                "Space" === e.code && (d = p.getVoice("space", i.ttsLangIsoCode)),
                    ...
                    void 0 === e.code && s && ((d = c), (u = 1)),
                    d && l({ contentToRead: d, readingDelay: 0, readingSpeedRate: u, language: i.ttsLangIsoCode });
            }
        }
        function a() {
            var e = function () {
                Array.from(document.querySelectorAll('table:not([data-uw-table-for-reader-processed="processed"]):not([role="presentation"])')).forEach(function (e) {
                    var t = Array.from(e.querySelectorAll("tr")),
                        ...
                        r = n
                            ? Array.from(t[0].children).map(function (e) {
                                  return " " + e.innerText;
                              })
        ...
        function o() {
            function e(n) {
                ...
                if (n.nodeType === Node.TEXT_NODE) {
                    ...
                    o && t.push({ text: o, lang: a.ttsLangIsoCode });
                }
            }
            var t = [],
                n = [];
            if (u()) {
                for (
                    var r = document.querySelectorAll('[role="alert"], [aria-live="assertive"]'),
                        i = Array.from(r).filter(function (e, t, n) {
                ...
                (b = t),
                    n.forEach(function (e) {
                        var t = e.text,
                            n = e.lang;
                        return l({ isAlert: !0, language: n, contentToRead: t });
                    });
            }
        }
        var l,
...
!(function (e) {
    ...
    (function () {
        ...
        function n() {
            ...
            try {
                p.reset(), d.terminate(), c.postMessage({ action: ACTIONS.READER_END }, ["userway", "uwAccessibilityEditor"]);
            } catch (e) {}
        }
        function r(e, n, r) {
            return new Promise(function (o, l) {
                var s = { started: function () {}, completed: o, failed: l };
                ...
                handle: function () {
                    return new Promise(function (r) {
                        ...
                        d.read(e, t.locale.ttsVoiceName, {
                            ...
                            onend: function () {
                                c.postMessage({ action: ACTIONS.READER_END }, ["userway", "uwAccessibilityEditor", "uwInlineDictionary"]),
                                    setTimeout(function () {
                                        r(), n.completed();
                                    }, t.readingDelay);
                            },
                            onerror: function (e) {
                                c.postMessage({ action: ACTIONS.READER_END }, ["userway", "uwAccessibilityEditor", "uwInlineDictionary"]), r(), n.failed(), g && console.error(e);
                            },
    ...
    (function () {
        ...
        function r(e, t) {
            var n = { event: "command", func: t, args: "" };
            e.contentWindow.postMessage(JSON.stringify(n), "*");
        }
        var i = "www.youtube",
